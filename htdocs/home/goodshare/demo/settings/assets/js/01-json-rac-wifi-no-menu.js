const demoAppJson = {
  ...
  slides: [
    ...
    },
    {
      index: 5,
      alt: 'STEP-06',
      imagePath: '../assets/img/01601.svg',
    ...
    },
    {
      ...
      tooltipDescription: 'ここからは、機器のアクセスポイントモードを使った機器とルーターの接続方法を説明します。画面の内容を確認し次へ進む、その他の接続方法は以下から選択ください。<ul class="mt-3"><li><a href="./?slide=21">WPS機能での接続</a></li><li><a href="./?slide=26">機器とルーターを接続済み</a></li></ul><div class="d-flex justify-content-end"><button type="button" class="btn btn-secondary btn-sm tippy-close-btn">閉じる</button></div>',
      noArrow: true,
      footerContent:
    ...
    },
    {
      ...
      footerContent:
        '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon021">エアコンをアクセスポイント（APモード）にする</a></li><li>詳しくは<a href="https://www.mitsubishielectric.co.jp/home/mymu/entry_ib_pdf.html">機器登録説明書、または機器個別の登録手順</a>（各機器の登録部分を抜粋した説明書）から、機器を登録する事項を確認ください。</li></ul>',
    },
    {
      index: 11,
      alt: 'STEP-12',
    ...
    },
    {
      ...
      footerContent:
        '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon023">エアコンとスマートフォンを接続する</a></li></ul>',
    },
    {
      index: 13,
      alt: 'STEP-14',
    ...
    },
    {
      ...
      footerContent:
        '<ul><li>エアコン登録と初期設定が完了しました。霧ヶ峰アプリの使い方については、霧ヶ峰アプリの取扱説明書を確認ください。</li><li>エモコアイ搭載エアコンの場合、<a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon031">「次へ」</a>が表示されます。タップして操作を続けてください。</li></ul>',
    },
    {
      index: 20,
      alt: 'STEP-21',
      imagePath: '../assets/img/03102.svg',
      tooltipTarget: 'targetObj',
      // tooltipTarget: 'targetArea03102',
      tooltipDescription: '「ホームに戻る」をタップ、ホーム画面に戻る',
      footerContent:
        '<ul><li>エモコアイ搭載エアコンの登録が完了しました。</li><li>エアコン名は設置されている部屋名称に変更することをお勧めします(リビングのエアコンなど)。変更方法は<a href="https://www.mitsubishielectric.co.jp/home/mymu/ib.html">MyMUアプリの取扱説明書</a>から、「登録機器一覧を確認する」の事項を確認ください（ユーザー種別が「管理者」のみ行えます）。</li></ul>',
    },
    {
      index: 21,
      alt: 'STEP-22',
    ...
    },
    {
      ...
      tooltipDescription: '「ホームに戻る」をタップ、ホーム画面に戻る<div class="d-flex justify-content-center mt-3"><a role="button" href="../" class="btn btn-outline-secondary d-flex justify-content-between gap-2"><i class="bi bi-chevron-left"></i>機器選択画面に戻る</a></div>',
      footerContent:
        '<ul><li>エモコアイ搭載エアコンの登録が完了しました。</li><li>エアコン名は設置されている部屋名称に変更することをお勧めします(リビングのエアコンなど)。変更方法は<a href="https://www.mitsubishielectric.co.jp/home/mymu/ib.html">MyMUアプリの取扱説明書</a>から、「登録機器一覧を確認する」の事項を確認ください（ユーザー種別が「管理者」のみ行えます）。</li></ul>',
    },
  ],
