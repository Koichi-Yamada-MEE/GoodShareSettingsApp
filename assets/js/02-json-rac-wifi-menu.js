const demoAppJson = {
  ...
  slides: [
    ...
    },
    {
      ...
      footerContent: '<ul><li>リモコンにメニューボタンがない場合はやり直してください。</li></ul>',
    },
    {
      index: 6,
      alt: 'STEP-07',
    ...
    },
    {
      ...
      footerContent: '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon050">エアコンをアクセスポイント（APモード）にする</a></li></ul>',
    },
    {
      index: 11,
      alt: 'STEP-12',
    ...
    },
    {
      ...
      tooltipDescription: '画面の内容を確認し、「次へ」をタップする',
      footerContent: '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon051">情報シールを確認する</a></li></ul>',
    },
    {
      index: 13,
      alt: 'STEP-14',
      ...
      footerContent: '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon054">エアコンとスマートフォンを接続する</a></li></ul>',
    },
    {
      index: 14,
      alt: 'STEP-15',
    ...
    },
    {
      ...
      tooltipDescription: '画面の内容を操作し、「次へ」をタップする',
      footerContent: '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon065">リモコンを使ってエアコンを接続モードにする</a></li></ul>',
    },
    {
      index: 24,
      alt: 'STEP-25',
