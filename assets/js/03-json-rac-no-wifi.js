const demoAppJson = {
  ...
  slides: [
    ...
    },
    {
      ...
      footerContent: '<ul><li>リモコンの停止ボタンの近くに「<span class="fw-bold">長押しで無線無効</span>」の文字がないかご確認ください。</li><li>「長押しで無線無効」の文字がある場合はやり直してください。</li></ul>',
    },
    {
      index: 5,
      alt: 'STEP-06',
    ...
    },
    {
      ...
      footerContent: '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon080">リモコンを使ってエアコンを接続モードにする</a></li></ul>',
    },
    {
      index: 10,
      alt: 'STEP-11',
    ...
    },
    {
      ...
      tooltipDescription: '画面の内容を確認し、「次へ」をタップする',
      footerContent: '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon083">設定情報シールを確認する</a></li></ul>',
    },
    {
      index: 12,
      alt: 'STEP-13',
    ...
    },
    {
      ...
      footerContent: '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon02603">「前回使用した暗号化キーを入力する」</a>を選択すると、前回使用した暗号化キーを自動入力できます。</li></ul>',
    },
    {
      index: 16,
      alt: 'STEP-17',
    ...
    },
    {
      ...
      tooltipDescription: '画面に表示されている操作を行い、「次へ」をタップする',
      footerContent: '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon095">リモコンを使ってエアコンを接続モードにする</a></li></ul>',
    },
    {
      index: 23,
      alt: 'STEP-24',
    ...
    },
    {
      ...
      tooltipDescription: '画面に表示されている操作を行い、「次へ」をタップする',
      footerContent: '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon098">エアコンとルーターの接続が完了したこと確認する</a></li><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon020">WPS接続できないときの対処方法</a></li></ul>',
    },
    {
      index: 25,
      alt: 'STEP-26',
