const demoAppJson = {
  ...
  slides: [
    ...
    },
    {
      ...
      footerContent:
        'ルーターにWPS機能がない場合はアクセスポイントモードで接続、WPS機能がある場合はルーターの「WPS」ボタンを使って接続してください。WPS機能がない場合はWPSによる接続はできません。',
    },
    {
      index: 7,
      alt: 'STEP-08',
      ...
      tooltipDescription: 'ここからは、機器のアクセスポイントモードを使った機器とルーターの接続方法を説明します。画面の内容を確認し、次へ進んでください。<br /><div class="d-flex justify-content-end"><button type="button" class="btn btn-secondary btn-sm tippy-close-btn">閉じる</button></div>',
      footerContent:
        'エアコン、スマートフォン、リモコン、ルーター、ルーターのSSID（2.4GHz）、ルーターに接続する暗号化キー（パスワード）を準備ください。',
    },
    {
      index: 8,
      alt: 'STEP-09',
