const demoAppJson = {
  ...
  slides: [
    ...
    },
    {
      ...
      footerContent:
        '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon021">エアコンをアクセスポイント（APモード）にする</a></li><li>詳しくは<a href="https://www.mitsubishielectric.co.jp/home/mymu/entry_ib_pdf.html">機器登録説明書</a>をご確認ください。</li></ul>',
    },
    {
      index: 11,
      alt: "STEP-12",
