const demoAppJson = {
  ...
  slides: [
    ...
    },
    {
      ...
      footerContent: '<ul><li>リモコンの停止ボタンの近くに「<span class="fw-bold">長押しで無線無効</span>」の文字があるかご確認ください。</li><li>「長押しで無線無効」の文字がない場合はやり直してください。</li></ul>',
    },
    {
      index: 5,
      alt: 'STEP-06',
      ...
      footerContent: '<ul><li>リモコンにメニューボタンがある場合はやり直してください。</li></ul>',
    },
    {
      index: 6,
      alt: 'STEP-07',
      ...
      tooltipDescription: '機器とルーターの接続方法を選択します。<br><button type="button" class="btn btn-outline-primary mt-2 d-block mx-auto" data-bs-toggle="modal" data-bs-target="#modalCommon017">選択メニューを表示</button>',
      footerContent: '',
    },
    {
      index: 7,
    ...
    },
    {
      ...
      tooltipDescription: '画面の内容を確認し、「次へ」をタップする',
      footerContent: '<ul><li>事前に以下の準備をしてください。<i class="bi bi-1-circle"></i>接続したいルーターのSSID(2.4GHz)、<i class="bi bi-2-circle"></i>ルーターに接続する暗号化キー(パスワード)</li><li>本アプリでルーターのSSIDに使用できる文字は<a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon018">半角英数字、半角記号、半角スペース</a>です。</li></ul>',
    },
    {
      index: 9,
      alt: 'STEP-10',
    ...
    },
    {
      ...
      footerContent: '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon021">エアコンをアクセスポイント（APモード）にする</a></li><li>詳しくは<a href="https://www.mitsubishielectric.co.jp/home/mymu/entry_ib_pdf.html">機器登録説明書</a>から「エアコン」の「無線LAN内蔵エアコン（メニューボタンなし）を登録する（AP）」をご確認ください。</li></ul>',
    },
    {
      index: 11,
      alt: 'STEP-12',
    ...
    },
    {
      ...
      footerContent: '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon023">エアコンとスマートフォンを接続する</a></li></ul>',
    },
    {
      index: 13,
      alt: 'STEP-14',
    ...
    },
    {
      ...
      footerContent: '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon02603">「暗号化キーを表示する」</a>を選択すると、前回使用した暗号化キーを自動入力できます。</li></ul>',
    },
    {
      index: 16,
      alt: 'STEP-17',
    ...
    },
    {
      ...
      footerContent: '<ul><li>エアコン登録と初期設定が完了しました。霧ヶ峰アプリの使い方については、霧ヶ峰アプリの取扱説明書をご確認ください。</li><li>エモコアイ搭載エアコンの場合、<a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon031">「次へ」</a>が表示されます。タップして操作を続けてください。</li></ul>',
    },
    {
      index: 20,
      alt: 'STEP-21',
    ...
    },
    {
      ...
      tooltipDescription: '画面の内容を操作し、「次へ」をタップする',
      footerContent: '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon022">リモコンを使ってエアコンを接続モードにする</a></li></ul>',
    },
    {
      index: 24,
      alt: 'STEP-25',
      ...
      tooltipDescription: '画面の内容を操作し、「次へ」をタップする',
      footerContent: '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon035">ルーターをWPSモードにする</a></li></ul>',
    },
    {
      index: 25,
      alt: 'STEP-26',
      ...
      tooltipDescription: '画面の内容を操作し、「次へ」をタップする',
      footerContent: '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon036">エアコンとルーターの接続が完了したことを確認する</a></li></ul>',
    },
    {
      index: 26,
      alt: 'STEP-27',
    ...
    },
    {
      ...
      footerContent: '<ul><li>複数の機器が表示された場合、<img class="mt-0 align-text-bottom" src="../assets/img/rac/buzzer.svg">ブザー鳴動ボタンをタップし、登録するエアコンからブザー音が鳴ることを確認してください。</li><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon02802">エアコンが別のユーザーに登録されている場合</a></li></ul>',
    },
    {
      index: 28,
      alt: 'STEP-29',
