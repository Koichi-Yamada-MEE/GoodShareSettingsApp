const demoAppJson = {
  ...
  slides: [
    ...
    },
    {
      ...
      footerContent:
        '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon021">エアコンをアクセスポイント（APモード）にする</a></li><li>詳しくは<a href="https://www.mitsubishielectric.co.jp/home/mymu/entry_ib_pdf.html">機器登録説明書</a>から「エアコン」の「無線LAN内蔵エアコン（メニューボタンなし）を登録する（AP）」をご確認ください。</li></ul>',
    },
    {
      index: 11,
      alt: "STEP-12",
    ...
    },
    {
      ...
      footerContent:
        '<ul><li>エモコアイ搭載エアコンの登録が完了しました。</li><li>エアコン名は設置されている部屋名称に変更することをお勧めします(リビングのエアコンなど)。変更方法は<a href="https://www.mitsubishielectric.co.jp/home/mymu/ib.html">MyMUアプリの取扱説明書</a>をご確認ください。</li></ul>',
    },
    {
      index: 21,
      alt: "STEP-22",
    ...
    },
    {
      ...
      footerContent:
        '<ul><li>複数の機器が表示された場合、<img class="mt-0 align-text-bottom" src="../assets/img/rac/buzzer.svg">ブザー鳴動ボタンをタップし、登録するエアコンからブザー音が鳴ることを確認してください。</li><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon02802">エアコンが別のユーザーに登録されている場合</a></li></ul>',
    },
    {
      index: 28,
      alt: "STEP-29",
