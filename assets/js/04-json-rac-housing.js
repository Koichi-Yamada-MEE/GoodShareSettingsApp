const demoAppJson = {
  ...
  slides: [
    ...
    },
    {
      ...
      footerContent: '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon111">エアコンをアクセスポイント（APモード）にする</a></li></ul>',
    },
    {
      index: 9,
      alt: 'STEP-10',
    ...
    },
    {
      ...
      tooltipDescription: '画面の内容を確認し、「次へ」をタップする',
      footerContent: '<a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon113">設定情報シールを確認する</a>',
    },
    {
      index: 11,
      alt: 'STEP-12',
    ...
    },
    {
      ...
      tooltipDescription: '画面の内容を操作し、「次へ」をタップする',
      footerContent: '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalCommon125">リモコンを使ってエアコンを接続モードにする</a></li></ul>',
    },
    {
      index: 22,
      alt: 'STEP-23',
